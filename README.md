...
La version actuelle est `1.3.11.38`. Elle comprend la bibliothèque locale, la
...
La commande `installer/Build-Installer.ps1 -Version 1.3.11.38` publie l’application
