...
La version actuelle est `1.2.10.37`. Elle comprend la bibliothèque locale, la
...
La commande `installer/Build-Installer.ps1 -Version 1.2.10.37` publie l’application
