...
Le projet est en phase d'initialisation. La version actuelle est `0.1.7.17` :
...
La commande `installer/Build-Installer.ps1 -Version 0.1.7.17` publie l’application
