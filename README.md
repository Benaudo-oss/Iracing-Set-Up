...
La version actuelle est `1.2.9.28`. Elle comprend la bibliothèque locale, la
...
La commande `installer/Build-Installer.ps1 -Version 1.2.9.28` publie l’application
