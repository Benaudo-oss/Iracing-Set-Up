...
La version actuelle est `1.5.12.44`. Elle comprend la bibliothèque locale, la
...
La commande `installer/Build-Installer.ps1 -Version 1.5.12.44` publie l’application
