...
La version actuelle est `1.2.9.27`. Elle comprend la bibliothèque locale, la
...
La commande `installer/Build-Installer.ps1 -Version 1.2.9.27` publie l’application
