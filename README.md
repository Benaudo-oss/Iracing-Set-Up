...
La version actuelle est `1.3.12.39`. Elle comprend la bibliothèque locale, la
...
La commande `installer/Build-Installer.ps1 -Version 1.3.12.39` publie l’application
