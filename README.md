...
La version actuelle est `1.2.9.33`. Elle comprend la bibliothèque locale, la
...
La commande `installer/Build-Installer.ps1 -Version 1.2.9.33` publie l’application
